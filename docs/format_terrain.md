...
|--------|-----------|-----------|---------|
| [THM](format_thm.md) | `.thm` | float32 per vertex | Elevation/height data |
| [TMM](format_tmm.md) | `.tmm` | uint8 per vertex | Material/texture assignment |
| [TLM](format_tlm.md) | `.tlm` | RGBA per pixel | Baked lighting and shadows |
...
- [THM Format](format_thm.md) — height map binary format details
- [TMM Format](format_tmm.md) — material map binary format details
- [TLM Format](format_tlm.md) — light map binary format details
